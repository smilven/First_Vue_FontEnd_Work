    ...
    <form action="" class="container mb-3">
        <div class="row">
            ...
            <div class="mb-3">
                ...
                <textarea type="text" class="form-control" row="5" v-model="page.pageContent"></textarea>
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" v-model="page.linkText">
                ...
                <div class="row mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="gridChcek1">Published</label>
                    </div>
                </div>
          </div>
